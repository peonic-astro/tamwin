...
> Single source of truth for everything the party carries.
> Update this file for EVERY acquisition, use, trade, or loss.
...
- **Shortsword** (at belt)
- **Dagger** x2 (one at belt, one in boot)
- **Shortbow** (slung over shoulder)
- **Backpack**
...
- **Waterskin** (full)
- **Hempen rope** (50 feet)
- **Smoking pipe** (personal item)
- **Carved wooden badger** (token from Da, kept in pocket)

### Special Items & Quest Items
- **Wooden gaming die** (worn smooth, taken from dead bandit)
- **Blue cloth scrap** (faded, knotted, taken from dead bandit's wrist - unknown significance)
...
## Encumbrance
- **Carrying Capacity:** 180 lbs (STR 12 x 15)
- **Current Load:** ~45 lbs (light load, no penalties)
